    ...
    deletar = () => {
        this.service
            ...
            .then(response => {
                ...
                messages.mensagemSucesso('Registro deletado com sucesso!');
            })
            .catch(erro => {
    ...
    render(){
        ...
        const confirmDialogFooter = (
            <div>
                ...
                <Button label="Não" icon="pi pi-times" onClick={this.cancelarDeletar} className="p-button-secondary" />
            </div>
        )
